...
const Icon: React.FC<SvgProps> = (props) => {
  ...
  return (
    <Svg viewBox="0 0 32 32" {...props}>
      <path d="M32 16c0 8.837-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0s16 7.163 16 16z" fill="#F7BE2F" />
      ...
      <g mask="url(#A)">
        ...
        <path
          ...
          fill="#F7BE2F"
        />
        <ellipse cx="12.308" cy="14.846" rx="1.026" ry="1.538" fill="#F7BE2F" />
        <ellipse cx="19.385" cy="14.846" rx="1.026" ry="1.538" fill="#F7BE2F" />
      </g>
    </Svg>
  );
};
